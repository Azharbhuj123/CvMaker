...
//                   getStartDate(moment(date).format('YYYY-MM'))
//                 }}
//               ></DatePicker>
//             </div>
//             <h6>-</h6>
...
//                 // }
//                 value={
//                   education[accordianIndex]?.toggle ? 'dags dato' : endDate
//                 }
//                 onChange={(date) => {
//                   if (education[accordianIndex]?.toggle) {
//                     // handleChange('endDate', moment().format('YYYY-MM'))
//                     setStartDate(moment().format('YYYY-MM'))
//                     getStartDate(moment().format('YYYY-MM'))
//                   } else {
//                     // handleChange('endDate', moment(date).format('YYYY-MM'))
//                     setStartDate(moment(date).format('YYYY-MM'))
//                     getStartDate(moment(date).format('YYYY-MM'))
